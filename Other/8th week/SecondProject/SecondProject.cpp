...
LRESULT CALLBACK LAB6(HWND hDlg, UINT message, WPARAM wParam, LPARAM lParam) //napravih prototip Lab7 Lab 8
{
	switch (message)
	{
	case WM_TIMER: // Lab 8
	...
	break;
	case WM_INITDIALOG: // инициализираме диалоговата кутия  8th week Lab7 Lab 8
	{
